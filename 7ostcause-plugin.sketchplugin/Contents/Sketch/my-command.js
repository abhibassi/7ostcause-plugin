...
function onStartup() {
  ...
  DataSupplier.registerDataSupplier("public.text", "7ostcause-plugin", "SupplyData"); // DataSupplier.registerDataSupplier('public.image', '7ostcause-plugin', 'SupplyData')
}
function onShutdown() {
